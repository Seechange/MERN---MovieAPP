...
import { ORIGINAL_IMG_TMDB, SMALL_URL_TMDB } from "../utils/constants"
...
const WatchPage = () => {
    ...
    useEffect(() => {
        const getTrailers = async () => {
            try {
                const res = await axiosInstance.get(`/${contentType}/${id}/trailer`);
    ...
    return (
        <div className='bg-black min-h-screen text-white'>
            ...
            >
                ...
                <img
                    src={ORIGINAL_IMG_TMDB + content?.poster_path}
                    alt='Poster image'
                        ...
                        {similarContent.map((content) => {
                            ...
                            return (
                                <Link key={content.id} to={`/watch/${content.id}`} className='w-52 flex-none'>
                                    <img
                                        src={SMALL_URL_TMDB + content.poster_path}
                                        alt='Poster path'
